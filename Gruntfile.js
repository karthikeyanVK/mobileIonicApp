// Generated on 2015-08-26 using generator-angular 0.12.1
'use strict';
    ...
    imagemin: {
      appimages: {
        ...
        files: [{
          ...
          src: ['<%= yeoman.images %>/**/*.{png,jpg,gif,svg}'], // Actual patterns to match
          dest: '<%= yeoman.temp %>/' // Destination path prefix
        }]
      },
      dist: {
        files: [{
